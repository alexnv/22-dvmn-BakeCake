...
class UtmCheckin(models.Model):
    ...
    utm_source = models.CharField('Источник UTM', max_length=100, blank=True, default='', null=True)
    utm_medium = models.CharField('Тип траффика', max_length=10, blank=True, default='', null=True)
    utm_campaign = models.CharField('Название компании', max_length=100, blank=True, default='', null=True)
    utm_content = models.CharField('Идентификатор объявления', max_length=250, blank=True, default='', null=True)
    utm_term = models.CharField('Ключевое слово', max_length=100, blank=True, default='', null=True)

    page = models.CharField('Адрес страницы', blank=True, max_length=200, default='', null=True)
    ...
    def str(self):
        return f"{self.page} - {self.utm_source}"
